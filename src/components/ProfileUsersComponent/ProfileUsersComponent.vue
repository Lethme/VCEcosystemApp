  ...
  <div class="table-wrapper">
    ...
    >
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
        ...
        <a-input size="large" required :disabled="createModalConfirmLoading" class="w-100" v-model:value="createUserState.username" @pressEnter="createUser" />
      </div>
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
        <h6>{{ $locale.userProfilePage.usersTableHeaders.lastName }}</h6>
        <a-input size="large" required :disabled="createModalConfirmLoading" class="w-100" v-model:value="createUserState.lastName" @pressEnter="createUser" />
      </div>
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
        <h6>{{ $locale.userProfilePage.usersTableHeaders.firstName }}</h6>
        <a-input size="large" required :disabled="createModalConfirmLoading" class="w-100" v-model:value="createUserState.firstName" @pressEnter="createUser" />
      </div>
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
        <h6>{{ $locale.userProfilePage.usersTableHeaders.patronymic }}</h6>
        <a-input size="large" required :disabled="createModalConfirmLoading" class="w-100" v-model:value="createUserState.patronymic" @pressEnter="createUser" />
      </div>
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
    ...
    >
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
        <h6>{{ $locale.userProfilePage.usersTableHeaders.username }}</h6>
        <a-input size="large" required :disabled="createModalConfirmLoading" class="w-100" v-model:value="editUserState.username" @pressEnter="editUser" />
      </div>
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
        <h6>{{ $locale.userProfilePage.usersTableHeaders.lastName }}</h6>
        <a-input size="large" required :disabled="createModalConfirmLoading" class="w-100" v-model:value="editUserState.lastName" @pressEnter="editUser" />
      </div>
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
        <h6>{{ $locale.userProfilePage.usersTableHeaders.firstName }}</h6>
        <a-input size="large" required :disabled="createModalConfirmLoading" class="w-100" v-model:value="editUserState.firstName" @pressEnter="editUser" />
      </div>
      <div class="input-wrapper d-flex flex-column align-items-start py-2">
        <h6>{{ $locale.userProfilePage.usersTableHeaders.patronymic }}</h6>
        <a-input size="large" required :disabled="createModalConfirmLoading" class="w-100" v-model:value="editUserState.patronymic" @pressEnter="editUser" />
      </div>
      <div v-if="!(editUserRecord.roles.length === 1 && editUserRecord.roles[0].value === ApiRole.Root)" class="input-wrapper d-flex flex-column align-items-start py-2">
        <h6>{{ $locale.userProfilePage.usersTableHeaders.roles }}</h6>
        <a-select
