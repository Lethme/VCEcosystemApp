...
export const ru: LocaleRecord = {
    ...
    sendBotMessageText: "Вы можете отправить выбранным пользователям сообщение через Телеграм Бота",
    yourTelegramIdText: "Ваш Телеграм ID",
    youCanLinkTelegramText: "Вы можете привязать свой Телеграм аккаунт",
    ...
    newOrdersPage: {
        ...
        orderServicesTableHeaders: {
            ...
            price: "Цена, ₽/штука",
            totalPrice: "Стоимость, ₽",
            totalAmount: "Итоговое количество",
            amount: "Количество",
