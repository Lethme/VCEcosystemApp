...
export const en: LocaleRecord = {
    ...
    removeAllNotificationsText: "Remove All Notifications",
    noNotificationsText: "You have no notifications right now",
    notificationsTitleText: "Notifications",
    sendBotMessageText: "You can send any message to selected users from Telegram Bot",
    yourTelegramIdText: "Your Telegram ID",
    youCanLinkTelegramText: "You can link your Telegram Account",
